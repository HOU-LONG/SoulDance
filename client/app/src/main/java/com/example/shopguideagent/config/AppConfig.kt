...
object AppConfig {
    ...
    const val BASE_HTTP_URL = "https://enrolled-balanced-holds-inexpensive.trycloudflare.com/"
    const val BASE_WS_URL = "wss://enrolled-balanced-holds-inexpensive.trycloudflare.com"
