...
from ..services.cart_intent import (
    _detect_cart_action,
...
from ..comparison.comparison_presenter import comparison_item, comparison_reason
from ..planning.constraint_filter import canonical_brand, dedupe, extract_excluded_brands, hard_filter
from ..utils import extract_json
from ..retrieval.embedding_retriever import BM25OnlyRetriever
from ..adapters.image_assets import product_image_url_auto as product_image_url
from ..retrieval.knowledge_base import evidence_review_summary, product_evidence
...
from ..memory.memory_cache import RecommendationMemoryCache, RecommendationMemoryHit, StructuredMemoryCache
from ..models import (
    ChatRequest,
    ContextEvent,
    DisplayMessage,
...
from ..retrieval.ranker import rank_products
from ..services.reference_resolver import ReferenceResolver
from ..planning.semantic_layer import rule_semantic_frame
from ..services.session_store import SessionStore
from ..planning.state_reducer import StateReducer, seed_constraint_state_from_plan
from ..retrieval.taxonomy import TaxonomyResolver
from ..services.timeout_policy import TimeoutBudget, run_with_timeout
from ..pipeline.degradation import fallback_text_for_failure
from ..pipeline.fact_context import FactContextBuilder
from ..pipeline.anchor_validator import AnchorValidator
from ..pipeline.consistency_tracker import ConsistencyTracker
...
class ShopGuideAgent:
    def __init__(
        ...
        *,
        ...
        from ..retrieval.product_matcher import ProductMatcher
        self.product_matcher = ProductMatcher(self.retriever, products=products)
        # Phase B: LLM 优先的工具调度器
        from ..planning.tool_planner import ToolPlanner
