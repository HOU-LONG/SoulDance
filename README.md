...
1. **先共情，再推荐**：识别"情绪+购物"复合需求（"心情不好推荐甜的"），LLM 先安抚情绪再自然带出商品卡片
2. **模糊语义→精准商品**：用户说"小棕瓶""华为 P70""雀巢咖啡"都能模糊匹配库内长标题商品
3. **对话即决策**：一条消息完成 共情→推荐→加购，零页面跳转
...
| 文档 | 内容 |
|------|------|
| `docs/design.md` | **设计文档**：系统架构 / 技术栈 / 产品&技术亮点 / 关键方案 |
